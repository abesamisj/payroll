        ...
        public List<PayrollTransactionViewModels> GetAllPayrollTransactions()
        {
            ...
            using (var db = new PayrollEntities())
            {
                var query = from b in db.PayrollTransactions
                            ...
                            join d in db.UserPersonalInformations on b.UserPersonalInformationId equals d.UserPersonalInformationId
                            join e in db.Departments on b.DepartmentId equals e.DepartmentId
                            join f in db.Incomes on b.IncomeId equals f.IncomeId
                            join g in db.Deductions on b.DeductionId equals g.DeductionId
                            orderby d.LastName ascending
                            select new { b.PayrollPeriodId, b.CustomDeductionAmount, b.CustomIncomeAmount
                            , b.DeductionId, b.DepartmentId, b.IncomeId, b.PayrollTransactionId, b.TotalDeductionAmount
                            , b.TotalIncomeAmount, b.UserPersonalInformationId, c.Month, c.PayPeriodFrom
                            , c.WorkHours, c.WorkDays, d.EmployeeId, d.FirstName, d.LastName, d.Position, d.BasicPay
                            , e.DepartmentName, f.IncomeName, f.IncomeValue, g.DeductionName, g.DeductionValue};
